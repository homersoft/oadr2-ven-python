...
class EventHandlerTest(unittest.TestCase):
    ...
    def test_build_error_response(self):
        ...
        err_code = payload.findtext('pyld:eiCreatedEvent/ei:eiResponse/ei:responseCode',
                                    namespaces=self.event_handler.ns_map)
    ...
    def test_build_created_payload(self):
        ...
        i = 0
        for res in payload.iterfind('pyld:eiCreatedEvent/ei:eventResponses/ei:eventResponse',
                                    namespaces=self.event_handler.ns_map):
            # Yank data
    ...
    def test_handle_payload(self):
        ...
        files = [
            # 'sample_oadrDistributeEvent.xml',             # First file generates validation errors, due to 'description' field
