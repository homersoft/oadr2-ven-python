...
#                print(etree.tostring(payload, pretty_print=True))
                # Get some data
                status_code = payload.findtext('pyld:eiCreatedEvent/ei:eventResponses/ei:eventResponse/ei:responseCode', namespaces=event.NS_B)
                opt_type = payload.findtext('pyld:eiCreatedEvent/ei:eventResponses/ei:eventResponse/ei:optType', namespaces=event.NS_B)
